...
function callback(request,mode){
  ...
  //普通の画面の場合のXML処理
    ...
    if (img_links_array.length >= 3) {
      top_imgs_html = '<br><h5>Top</h5><div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"><ol class="carousel-indicators"><li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li><li data-target="#carouselExampleIndicators" data-slide-to="1"></li><li data-target="#carouselExampleIndicators" data-slide-to="2"></li></ol><div class="carousel-inner"><div class="carousel-item active"><a href="' + img_links_array[0]['pagelink'] +'" target=”_blank”><img class="d-block w-100" src="' + img_links_array[0]['imglink'] + '" alt="First slide"></a><div class="carousel-caption"><h5><b>' + img_links_array[0]['title'] + '</b></h5></div></div><div class="carousel-item"><a href="' + img_links_array[1]['pagelink'] +'" target=”_blank”><img class="d-block w-100" src="' + img_links_array[1]['imglink'] + '" alt="Second slide"></a><div class="carousel-caption"><h5><b>' + img_links_array[1]['title'] + '</b></h5></div></div><div class="carousel-item"><a href="' + img_links_array[2]['pagelink'] +'" target=”_blank”><img class="d-block w-100" src="' + img_links_array[2]['imglink'] + '" alt="Third slide"></a><div class="carousel-caption"><h5><b>' + img_links_array[2]['title'] + '</b></h5></div></div></div><a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="sr-only">Previous</span></a><a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="sr-only">Next</span></a></div>';
      top_imgs.innerHTML = top_imgs_html + '<hr size="20" noshade><h5>New Articles</h5>';
    }
    main_contents.innerHTML = html + '<hr size="20" noshade>';
  }
